          ...
          {timeline.map((step, index) => (
            <div key={index} className="flex items-center mb-4 last:mb-0">
              ...
              {index < timeline.length - 1 && (
                <div className={`absolute left-4 w-px h-8 mt-8 ${
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex">
      ...
      <div className="w-64 bg-slate-800 text-white fixed h-full">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-8">MediTrust</h2>
      ...
      <div className="flex-1 ml-64 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Manage your medical cases and track fundraising progress</p>
          </div>
          ...
          {activeTab === 'dashboard' && (
            <>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">$51,250</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">{donorMessages.filter(m => !m.read).length}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                {cases.map((caseItem) => (
                  <div key={caseItem.id} className="bg-white rounded-lg shadow-sm border border-gray-200">
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(caseItem.status)}`}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  {cases.length > 0 && <StatusTimeline timeline={cases[0].timeline} />}
                </div>

                {/* Donor Messages */}
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">Donor Messages</h3>
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto">
                    {donorMessages.map((message) => (
                      <div key={message.id} className={`p-4 rounded-lg border transition-colors ${
                        !message.read 
          ...
          {activeTab === 'upload' && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
              ...
              <p className="text-gray-600">Upload medical records, prescriptions, and other relevant documents</p>
            </div>
          )}
